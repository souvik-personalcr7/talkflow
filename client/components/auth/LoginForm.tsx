      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          ...
          <div className="mt-2 flex justify-end">
            <Link href="/forgot-password" className="text-sm font-semibold text-black dark:text-indigo-400 hover:underline">
              Forgot Password?
            </Link>
          </div>
        ...
        <button
          ...
          className="w-full py-3 px-4 bg-black dark:bg-indigo-600 text-white rounded-lg font-semibold hover:bg-gray-800 dark:hover:bg-indigo-700 transition duration-300 shadow-md disabled:opacity-70 disabled:cursor-not-allowed"
        >
